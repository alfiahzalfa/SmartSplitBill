...
def added_item_view(
    participant: ParticipantData, item: AssignedItemData, current_assigned_total: float
) -> bool:
    ...
    with num_col:
        ...
        st.number_input(
            ...
            value=float(item.assigned_count),
            step=0.5,
            min_value=0.0,
...
def warning_summary_view(manager: SplitManager) -> bool:
    ...
    for item in items:
        ...
        if difference > 0.001:  # toleransi floating point
